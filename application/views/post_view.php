	...
	<div class="container">
		<div class="row">
			...
			<div class="container">
				...
				<form action="<?= base_url() ?>./index.php/post_controller/add_post" method='post' enctype="multipart/form-data" style=" padding-right: 176px; padding-top: 50px; background: pink; border-radius: 12px; 
